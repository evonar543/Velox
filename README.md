...
- Built-in privacy defaults: `DNT`, `Sec-GPC`, third-party cookie blocking, and password-manager disablement
...
- `VeloxCefApp::OnBeforeCommandLineProcessing` applies browser-shell switches that cut background services and keep GPU acceleration on.
- `BrowserPolicy` owns request-context preferences, third-party cookie policy, request header privacy signals, and ad/tracker blocking.
